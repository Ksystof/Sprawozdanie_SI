...
int main()
{
    ...
    */
    ...
    krawedzie =9;
    //Definija grafu:
    MacierzSasiedztwa[6][8] = 1;
    MacierzSasiedztwa[0][1] = 1;
    MacierzSasiedztwa[1][2] = 1;
    MacierzSasiedztwa[2][2] = 1;
    MacierzSasiedztwa[1][3] = 1;
    MacierzSasiedztwa[3][1] = 1;
    MacierzSasiedztwa[2][4] = 1;
    MacierzSasiedztwa[4][0] = 1;
    MacierzSasiedztwa[4][3] = 1;
    //---
    ...
    drukujIncydencji(MacierzIncydencji, wierzcholki, krawedzie);
